        ...
        {urgency.map((opt) => {
          ...
          return (
            <button
              ...
              className={
                active
                  ? "inline-flex min-h-[44px] items-center gap-2 rounded-[var(--radius-pill)] bg-[var(--primary)] px-4 py-2 text-sm font-semibold text-[var(--surface)] focus-visible:ring-2 focus-visible:ring-[var(--focus)] focus-visible:ring-offset-2 focus-visible:outline-none"
                  : "inline-flex min-h-[44px] items-center gap-2 rounded-[var(--radius-pill)] border border-[var(--border)] bg-[var(--surface)] px-4 py-2 text-sm font-medium text-[var(--ink)] hover:bg-[var(--background)] focus-visible:ring-2 focus-visible:ring-[var(--focus)] focus-visible:ring-offset-2 focus-visible:outline-none"
              }
            >
              {opt.dotClass ? (
                <span
