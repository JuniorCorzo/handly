...
export function MapView({
  ...
  return (
    <div className='relative flex h-[min(70dvh,720px)] w-full flex-col overflow-hidden rounded-[var(--radius-md)] border border-[var(--border)] bg-[var(--surface)]'>
      <div className='absolute left-4 right-4 top-4 z-10 md:left-1/2 md:w-[min(480px,calc(100%-32px))] md:-translate-x-1/2'>
      ...
      <div className='relative h-full w-full bg-[var(--background)]'>
        ...
        <span
          aria-hidden='true'
          className='absolute left-1/2 top-1/2 flex h-10 w-10 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full border border-[var(--surface)] bg-[var(--primary)] text-[var(--surface)] shadow'
        >
          <svg
            width='20'
            height='20'
      ...
      <div className='absolute bottom-4 left-4 right-4 z-10 rounded-[var(--radius-md)] border border-[var(--border)] bg-[var(--surface)] p-4 shadow-[0_4px_12px_oklch(0.23_0.02_173/0.10)] md:left-1/2 md:w-[min(480px,calc(100%-32px))] md:-translate-x-1/2'>
        ...
        <button
          type='button'
          onClick={onNavigate}
          className='mt-3 inline-flex min-h-[44px] w-full items-center justify-center gap-2 rounded-[var(--radius-sm)] bg-[var(--primary)] px-4 py-2 text-sm font-semibold text-[var(--surface)] hover:bg-[var(--primary)]/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--focus)] focus-visible:ring-offset-2'
        >
          <svg
            aria-hidden='true'
            width='16'
