  ...
  return (
    <div className='mx-auto flex w-full max-w-2xl flex-col gap-8 px-4 py-8 sm:px-6'>
      <section className='space-y-2'>
        ...
        <h1 className='text-3xl font-bold tracking-tight text-[var(--ink)] [text-wrap:balance] sm:text-4xl'>
          {isSuccess ? 'Entrega confirmada' : 'Compromiso confirmado'}
        </h1>
        <p className='max-w-prose text-sm leading-relaxed text-[var(--muted)] [text-wrap:pretty] sm:text-base'>
          {isSuccess
      ...
      <section aria-labelledby='logistics-heading' className='space-y-3'>
        ...
        <div className='overflow-hidden rounded-[var(--radius-md)] border border-[var(--border)] bg-[var(--surface)]'>
          <div className='relative h-32 w-full bg-[var(--background)]'>
            ...
            <span
              aria-hidden='true'
              className='absolute left-1/2 top-1/2 flex h-8 w-8 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-[var(--primary)] text-[var(--surface)] shadow'
            >
              <svg
                width='18'
                height='18'
          ...
          <div className='flex flex-col gap-3 p-4 sm:flex-row sm:items-center sm:justify-between'>
            ...
            <button
              type='button'
              onClick={onOpenMap}
              className='inline-flex min-h-[44px] items-center justify-center gap-2 rounded-[var(--radius-sm)] bg-[var(--primary)] px-4 py-2 text-sm font-semibold text-[var(--surface)] hover:bg-[var(--primary)]/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--focus)] focus-visible:ring-offset-2'
            >
              <svg
                aria-hidden='true'
                width='16'
      ...
      <div className='flex flex-col gap-3 border-t border-[var(--border)] pt-6'>
        {isSuccess ? (
          <>
            <a
              href='/needs'
              className='inline-flex min-h-[44px] items-center justify-center rounded-[var(--radius-sm)] bg-[var(--primary)] px-4 py-2 text-sm font-semibold text-[var(--surface)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--focus)] focus-visible:ring-offset-2'
            >
              Volver a necesidades
            </a>
            <a
              href='/settings'
              className='inline-flex min-h-[44px] items-center justify-center rounded-[var(--radius-sm)] border border-[var(--border)] bg-[var(--surface)] px-4 py-2 text-sm font-medium text-[var(--ink)] hover:bg-[var(--background)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--focus)] focus-visible:ring-offset-2'
            >
              Ver perfil
            </a>
          </>
          ...
          <button
            type='button'
            onClick={onNeedHelp}
            className='inline-flex min-h-[44px] w-full items-center justify-center rounded-[var(--radius-sm)] border border-[var(--border)] bg-[var(--surface)] px-4 py-2 text-sm font-medium text-[var(--ink)] hover:bg-[var(--background)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--focus)] focus-visible:ring-offset-2'
          >
            ¿Necesitás ayuda?
          </button>
        )}
