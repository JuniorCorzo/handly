  ...
  return (
    <div className='mx-auto flex w-full max-w-[480px] flex-col'>
      <header className='mb-12'>
        ...
        <h1 className='text-3xl font-bold leading-tight tracking-tight text-[var(--ink)] [text-wrap:balance] sm:text-4xl'>
        ...
        {steps.map((step) => (
          <li key={step.title} className='flex items-start gap-6'>
            ...
            <div className='flex flex-col gap-1'>
              ...
              <p className='text-sm leading-relaxed text-[var(--muted)] [text-wrap:pretty]'>
                {step.description}
              </p>
            </div>
          </li>
      ...
      <div className='mt-12 border-t border-[var(--border)] pt-8'>
        <a
          href={ctaHref}
          className='inline-flex min-h-[48px] w-full items-center justify-center rounded-[var(--radius-sm)] bg-[var(--primary)] px-4 py-3 text-sm font-semibold text-[var(--surface)] hover:bg-[var(--primary)]/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--focus)] focus-visible:ring-offset-2 active:translate-y-px'
        >
          {ctaLabel}
        </a>
      </div>
