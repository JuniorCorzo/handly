-- =========================================================================
-- Función Transaccional: create_pledge_tx
-- Incorpora reserva atómica, SOS-XXXX (Crockford Base32) y TTL dinámico
-- =========================================================================
...
DECLARE
  ...
  v_tries INT := 0;
BEGIN
  -- 1. Bloqueo de fila para evitar sobre-asignación concurrente (Race Condition Guard)
  ...
  -- 5. Retornar payload estructurado para confirmación inmediata
